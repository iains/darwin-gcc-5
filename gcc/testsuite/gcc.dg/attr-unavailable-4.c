...
int func1()
{
   ...
   z = w + x + y + g1 + g2 + g3;	/* { dg-error "'x' is unavailable: Avoid x" "" } */
					/* { dg-error "'y' is unavailable: Bad y" "y" { target *-*-* } 55  } */
					/* { dg-error "'g2' is unavailable: You can't use g2" "g2" { target *-*-* } 55  }  */
					/* { dg-error "'g3' is unavailable: You can't use g3" "g3" { target *-*-* } 55  } */
...
int func2(S1 *p)
{
  ...
  return p->u1.field6 + p->field8;	/* { dg-error "'field6' is unavailable: You can't use field6" "" } */
					/* { dg-error "'field8' is unavailable: You can't use field8" "field8" { target *-*-* } 73 } */
}
